...
const blog = {
    ...
    content: `
        ...
        A couple quick gripes I'd like to get off my chest: 1) the practice tests I took on Udemy by Neal Davis were worded confusingly and with sometimes downright incorrect English. This was dissappointing and surprising given the practice tests for the Cloud Practitioner were excellent. 2) I took the test remotely (not at a testing center) and had another poor experience. The software or my connection cut out at least 6 times, which is a huge disruptor. It meant spending extra team rereading the long questions.
